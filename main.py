...
g = Grafo()
g.inicializarGrafo()
lista_nos=list(g.getGrafo().nodes)
...
layout = [
    ...
    [
        ...
        sg.Combo(lista_nos, key="-ORIGEM-", size=(15, 1), font=("Inter", 10), pad=(5, 5), background_color="#FFFFFF"),
        sg.Text("Destino:", font=("Inter", 10), text_color=TEXT_COLOR, background_color=BACKGROUND_COLOR, pad=(5, 5)),
        sg.Combo(lista_nos, key="-DESTINO-", size=(15, 1), font=("Inter", 10), pad=(5, 5), background_color="#FFFFFF"),
